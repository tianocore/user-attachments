...
@if defined VS140COMNTOOLS (
   @set "COMMONTOOLSx64=%VS140COMNTOOLS%..\..\VC\bin\x86_amd64"
   @goto SetVs
)

@if defined VS120COMNTOOLS (
   @set "COMMONTOOLSx64=%VS120COMNTOOLS%..\..\VC\bin\x86_amd64"
   @goto SetVs
)

@if defined VS110COMNTOOLS (
   @set "COMMONTOOLSx64=%VS110COMNTOOLS%..\..\VC\bin\x86_amd64"
   @goto SetVs
)
...
@if defined VS90COMNTOOLS (
   @set "COMMONTOOLSx64=%VS90COMNTOOLS%..\..\VC\bin\x86_amd64"
   @goto SetVs
)
@echo.
